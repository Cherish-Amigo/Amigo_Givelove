                ...
                <div className='choose'>
                    ...
                    <div className='button'>
                        <div className='check_money'>
                            <label for="money"><input className="checkbox" type="radio" id="money" name="method" checked="checked" onChange={
                                (e) => checkOnlyOne(e.target)} onClick={() => {setCheck(0)
                            }}/><img src={money} className="money" alt="money" />금액 기부</label>
                        </div>
                        <div className='check_article'>
                            <label for="article"><input className="checkbox" type="radio" id="article" name="method" onChange={
                                (e) => checkOnlyOne(e.target)} onClick={() => {setCheck(1)
                            }}/><img src={article} className="article" alt="article" />물품 기부</label>
                        </div>
                    </div>
                </div>
                <hr className='hr' />
