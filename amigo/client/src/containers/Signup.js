...
function Signup() {
  ...
  const submitHandler = (e) => {
    ...
    axios.post("/userAuth/join", body).then((res) => console.log(res));
  };
  ...
  const buttonsubmitHandler = (e) => {
    ...
    axios.post("/userAuth/check", body).then((res) => console.log(res));
  };
        ...
        <div id="signupInput">
          ...
          <form onSubmit={submitHandler}>
            ...
            <form onSubmit={buttonsubmitHandler}>
              <button id="ck" name="id" value={Id} onChange={idHandler}>
                중복확인
              </button>
            </form>
